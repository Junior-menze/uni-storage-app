...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StashSpace — Student Storage in Nelspruit" },
      { name: "description", content: "Affordable student storage & logistics for UMP and TUT Nelspruit. Collection Fridays, secure storage, doorstep delivery from R400." },
      { name: "author", content: "StashSpace" },
      { property: "og:title", content: "StashSpace — Student Storage in Nelspruit" },
      { property: "og:description", content: "Collection, secure storage, and delivery for UMP & TUT students from R400." },
